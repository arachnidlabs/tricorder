...
/* They are defined starting with cy_boot v3.0 */
    ...
    #error Component KEES_ADC_DelSig_Mod_v2_30 requires cy_boot v3.0 or later
#endif /* (CY_ PSOC5LP) */
...
#define ADC_CFG1_RANGE              (5u)    
#define ADC_CFG1_SRATE              (20u)         
#define ADC_CFG1_REFERENCE          (2u)       
#define ADC_CFG1_BUF_GAIN           (1u)   
#define ADC_CFG1_CONV_MODE          (1u)     
#define ADC_CFG1_RANGE_VALUE        (2.048)
#define ADC_DEFAULT_STROBE                     (1u) 
#define ADC_DEFAULT_INTERNAL_CLK               (0u)           
...
/* Default Config */
/* ADC_CFG1 Sample Rate: 20 Samples per Second */
/* ADC_CFG1 Conversion Mode: 1 */
/* ADC_CFG1 Input Buffer Gain: 1   */
/* ADC_CFG1 Reference: 2 */
/* ADC_CFG1 Input Range: 5  */
/* ADC_CFG1 Resolution: 20 bits */
/* ADC_CFG1 Clock: 1318400 Hz */

#define ADC_CFG1_DEC_CR             (0X76u)
...
#define ADC_CFG1_DSM_REF2           (0X47u)
...
#define ADC_CFG1_CLOCKS_PER_SAMPLE  (0X10180u)
#define ADC_CFG1_CLOCK_FREQ         (1318400u)
#define ADC_CFG1_CP_CLOCK_FREQ      (5273600u)
#define ADC_CFG1_REFERENCE_VOLTAGE  (1.0240)
#define ADC_CFG1_COUNTS_PER_VOLT    (256000u)
#define ADC_CFG1_IDEAL_DEC_GAIN     (0X8EF2u)

#define ADC_CFG1_IDEAL_ODDDEC_GAIN  (0X8000u)

/* Input and DAC Cap values in pF */
#define ADC_CFG1_IPCAP1VALUE        (0X0890u)
...
#define ADC_CFG2_COUNTS_PER_VOLT    (32000u)
...
#define ADC_CFG3_COUNTS_PER_VOLT    (32000u)
...
#define ADC_CFG4_COUNTS_PER_VOLT    (32000u)
