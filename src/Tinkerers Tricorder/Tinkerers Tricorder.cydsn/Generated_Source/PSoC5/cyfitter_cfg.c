...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x0018u);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x029Au);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_XMHZ_CFG0), 0x3316u);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_PLL_P), 0x080Cu);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_MSTR0), 0x0101u);
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_MSTR0), 0x01u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BG_CR0, 0x0Eu);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP0_MX, 0x02050205u);
...
uint8 CYXDATA * const CYCODE Measure_Mux__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Measure_Mux__maskTable[4] = {
	0x80u, 0x80u, 
	0x02u, 0x01u, 
};

/*******************************************************************************
* Function Name: Measure_Mux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Measure_Mux_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*Measure_Mux__addrTable[channel] |= Measure_Mux__maskTable[channel];
		channel++;
		*Measure_Mux__addrTable[channel] |= Measure_Mux__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: Measure_Mux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Measure_Mux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*Measure_Mux__addrTable[channel] &= (uint8)~Measure_Mux__maskTable[channel];
		channel++;
		*Measure_Mux__addrTable[channel] &= (uint8)~Measure_Mux__maskTable[channel];
	}
}

int8 ResistiveTouch_1_AMux_curChannel = -1;

void ResistiveTouch_1_AMux_DisconnectAll(void)
{
	ResistiveTouch_1_AMux_curChannel = -1;
	CY_SET_REG8((void CYXDATA *)CYREG_PRT5_AG, 0x00u);
	CY_SET_REG8((void CYXDATA *)CYREG_SAR1_SW0, 0x00u);
}
...
{
	ResistiveTouch_1_AMux_curChannel++;
	switch (ResistiveTouch_1_AMux_curChannel)
	{
	case 3: /* to force jump table (not executed) */
		ResistiveTouch_1_AMux_curChannel = 3;
	case 4: /* to force jump table (not executed) */
		ResistiveTouch_1_AMux_curChannel = 4;
	case 5: /* to force jump table (not executed) */
		ResistiveTouch_1_AMux_curChannel = 5;
	case 6: /* to force jump table (not executed) */
		ResistiveTouch_1_AMux_curChannel = 6;
	case 7: /* to force jump table (not executed) */
		ResistiveTouch_1_AMux_curChannel = 7;
	case 2:
	default:
		ResistiveTouch_1_AMux_curChannel = 0;
	case 0:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT5_AG, 0x02u);
		CY_SET_REG8((void CYXDATA *)CYREG_SAR1_SW0, 0x02u);
		break;
	case 1:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT5_AG, 0x08u);
		CY_SET_REG8((void CYXDATA *)CYREG_SAR1_SW0, 0x08u);
		break;
	}
}
...
void cyfitter_cfg(void)
{
	...
	static const uint8 CYCODE BS_IOPINS0_0_VAL[] = {
		0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x2Au, 0x00u};
	...
	static const uint8 CYCODE BS_IOPINS0_2_VAL[] = {
		0x00u, 0x1Fu, 0x1Fu, 0x00u, 0x1Fu, 0x00u, 0x00u, 0x00u};

	/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
	static const uint8 CYCODE BS_IOPINS0_3_VAL[] = {
		0x00u, 0x28u, 0x28u, 0x00u, 0x00u, 0x00u, 0xD4u, 0x00u};
	...
	static const uint8 CYCODE BS_IOPINS0_5_VAL[] = {
		0x8Au, 0x00u, 0x00u, 0x8Fu, 0x0Fu, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u};
...

	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x40005A01u, /* Base address: 0x40005A00 Count: 1 */
			...
			0x40010643u, /* Base address: 0x40010600 Count: 67 */
			...
			0x4001153Au, /* Base address: 0x40011500 Count: 58 */
			0x40011613u, /* Base address: 0x40011600 Count: 19 */
			...
			0x40014406u, /* Base address: 0x40014400 Count: 6 */
			0x40014507u, /* Base address: 0x40014500 Count: 7 */
		...
		static const uint8 CYCODE BS_UDB_1_1_0_CONFIG_VAL[] = {
			0x06u, 0x00u, 0x00u, 0x00u, 0x01u, 0x00u, 0x02u, 0x00u, 0x02u, 0x0Cu, 0x00u, 0x02u, 0x02u, 0x01u, 0x05u, 0x00u, 
			0x02u, 0x08u, 0x04u, 0x00u, 0x07u, 0x00u, 0x00u, 0x01u, 0x00u, 0x01u, 0x00u, 0x00u, 0x00u, 0x01u, 0x00u, 0x00u, 
			0x04u, 0x08u, 0x00u, 0x00u, 0x02u, 0x02u, 0x04u, 0x04u, 0x04u, 0x01u, 0x02u, 0x00u, 0x06u, 0x00u, 0x00u, 0x01u, 
			0x00u, 0x0Eu, 0x07u, 0x01u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x02u, 0x00u, 0x00u, 0x00u, 0x04u, 
			0x64u, 0x03u, 0x20u, 0x00u, 0x00u, 0xCEu, 0xFBu, 0x0Du, 0x1Fu, 0xFFu, 0xFFu, 0xFFu, 0x22u, 0x00u, 0xF0u, 0x08u, 
			0x04u, 0x00u, 0x00u, 0x00u, 0x40u, 0x00u, 0x00u, 0x00u, 0x04u, 0x04u, 0x04u, 0x04u, 0x33u, 0x33u, 0x00u, 0x01u, 
	...
	ClockSetup();
	/* Set Flash Cycles based on newly configured 16.00MHz Bus Clock. */
