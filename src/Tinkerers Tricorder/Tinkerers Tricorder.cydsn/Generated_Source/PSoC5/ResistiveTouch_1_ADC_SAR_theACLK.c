/*******************************************************************************
* File Name: ResistiveTouch_1_ADC_SAR_theACLK.c
* Version 2.0
*
*  Description:
...
/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_Start(void) 
{
    /* Set the bit to enable the clock. */
    ResistiveTouch_1_ADC_SAR_theACLK_CLKEN |= ResistiveTouch_1_ADC_SAR_theACLK_CLKEN_MASK;
	ResistiveTouch_1_ADC_SAR_theACLK_CLKSTBY |= ResistiveTouch_1_ADC_SAR_theACLK_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    ResistiveTouch_1_ADC_SAR_theACLK_CLKEN &= (uint8)(~ResistiveTouch_1_ADC_SAR_theACLK_CLKEN_MASK);
	ResistiveTouch_1_ADC_SAR_theACLK_CLKSTBY &= (uint8)(~ResistiveTouch_1_ADC_SAR_theACLK_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_StopBlock(void) 
{
    if ((ResistiveTouch_1_ADC_SAR_theACLK_CLKEN & ResistiveTouch_1_ADC_SAR_theACLK_CLKEN_MASK) != 0u)
    {
...
#if defined(ResistiveTouch_1_ADC_SAR_theACLK__CFG3)
        CLK_DIST_AMASK = ResistiveTouch_1_ADC_SAR_theACLK_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ResistiveTouch_1_ADC_SAR_theACLK_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* ResistiveTouch_1_ADC_SAR_theACLK__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(ResistiveTouch_1_ADC_SAR_theACLK_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(ResistiveTouch_1_ADC_SAR_theACLK_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        ResistiveTouch_1_ADC_SAR_theACLK_CLKSTBY &= (uint8)(~ResistiveTouch_1_ADC_SAR_theACLK_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = ResistiveTouch_1_ADC_SAR_theACLK_GetSourceRegister();
    uint16 oldDivider = ResistiveTouch_1_ADC_SAR_theACLK_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ResistiveTouch_1_ADC_SAR_theACLK_CLKEN & ResistiveTouch_1_ADC_SAR_theACLK_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(ResistiveTouch_1_ADC_SAR_theACLK_DIV_PTR, clkDivider);
                ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(ResistiveTouch_1_ADC_SAR_theACLK_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(ResistiveTouch_1_ADC_SAR_theACLK_DIV_PTR, clkDivider);
				ResistiveTouch_1_ADC_SAR_theACLK_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 ResistiveTouch_1_ADC_SAR_theACLK_GetDividerRegister(void) 
{
    return CY_GET_REG16(ResistiveTouch_1_ADC_SAR_theACLK_DIV_PTR);
}


/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_SetModeRegister(uint8 modeBitMask) 
{
    ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC |= modeBitMask & (uint8)ResistiveTouch_1_ADC_SAR_theACLK_MODE_MASK;
}


/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_ClearModeRegister(uint8 modeBitMask) 
{
    ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(ResistiveTouch_1_ADC_SAR_theACLK_MODE_MASK));
}


/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ResistiveTouch_1_ADC_SAR_theACLK_GetModeRegister(void) 
{
    return ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC & (uint8)(ResistiveTouch_1_ADC_SAR_theACLK_MODE_MASK);
}


/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = ResistiveTouch_1_ADC_SAR_theACLK_GetDividerRegister();
    uint8 oldSrc = ResistiveTouch_1_ADC_SAR_theACLK_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC |= CYCLK_SSS;
        ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC =
            (ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC & (uint8)(~ResistiveTouch_1_ADC_SAR_theACLK_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ResistiveTouch_1_ADC_SAR_theACLK_GetSourceRegister(void) 
{
    return ResistiveTouch_1_ADC_SAR_theACLK_MOD_SRC & ResistiveTouch_1_ADC_SAR_theACLK_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ResistiveTouch_1_ADC_SAR_theACLK_SetPhaseRegister(uint8 clkPhase) 
{
    ResistiveTouch_1_ADC_SAR_theACLK_PHASE = clkPhase & ResistiveTouch_1_ADC_SAR_theACLK_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ResistiveTouch_1_ADC_SAR_theACLK_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ResistiveTouch_1_ADC_SAR_theACLK_GetPhaseRegister(void) 
{
    return ResistiveTouch_1_ADC_SAR_theACLK_PHASE & ResistiveTouch_1_ADC_SAR_theACLK_PHASE_MASK;
}
