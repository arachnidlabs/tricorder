...
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF_SIZE   65
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_NUM_IN_RPTS   1
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_BUF_SIZE   65
...
#define USBFS_MAX_REPORTID_NUMBER   0
...
void   USBFS_Resume(void) ;
    ...
    */
    ...
    uint8 USBFS_PutUsbMidiIn(uint8 ic, uint8* midiMsg, uint8 cable)
                                                            ;
...
#endif /* End USBFS_EP_MM == USBFS__EP_DMAAUTO */
#define USBFS_ARB_INT_MASK              ((USBFS_DMA1_REMOVE ^ 1) | \
                                                    (USBFS_DMA2_REMOVE ^ 1) << 1 | \
                                                    (USBFS_DMA3_REMOVE ^ 1) << 2 | \
                                                    (USBFS_DMA4_REMOVE ^ 1) << 3 | \
                                                    (USBFS_DMA5_REMOVE ^ 1) << 4 | \
                                                    (USBFS_DMA6_REMOVE ^ 1) << 5 | \
                                                    (USBFS_DMA7_REMOVE ^ 1) << 6 | \
                                                    (USBFS_DMA8_REMOVE ^ 1) << 7)
