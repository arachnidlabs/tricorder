...
void   USBFS_1_Resume(void) ;
    ...
    */
    ...
    void USBFS_1_InitEP_DMA(uint8 epNumber, uint8 *pData) ;
    ...
    uint8 USBFS_1_PutUsbMidiIn(uint8 ic, uint8* midiMsg, uint8 cable)
                                                            ;
...
#endif /* End USBFS_1_EP_MM == USBFS_1__EP_DMAAUTO */
#define USBFS_1_ARB_INT_MASK              ((USBFS_1_DMA1_REMOVE ^ 1) | \
                                                    (USBFS_1_DMA2_REMOVE ^ 1) << 1 | \
                                                    (USBFS_1_DMA3_REMOVE ^ 1) << 2 | \
                                                    (USBFS_1_DMA4_REMOVE ^ 1) << 3 | \
                                                    (USBFS_1_DMA5_REMOVE ^ 1) << 4 | \
                                                    (USBFS_1_DMA6_REMOVE ^ 1) << 5 | \
                                                    (USBFS_1_DMA7_REMOVE ^ 1) << 6 | \
                                                    (USBFS_1_DMA8_REMOVE ^ 1) << 7)
