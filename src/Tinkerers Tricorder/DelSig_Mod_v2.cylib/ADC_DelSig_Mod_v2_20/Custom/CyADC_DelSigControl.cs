...
namespace ADC_DelSig_Mod_v2_20
{
    public partial class CyADC_DelSigControl : UserControl
    {
        ...
        const string ERROR_INPUT_SINGLE_OTHER_CONF = "You have to choose Single Ended input range, "+
                                                     "in other configuration tab.";
        const string ERROR_INPUT_DIFFERENTIAL = "You have to choose Differential input range.";
        const string ERROR_INPUT_DIFFERENTIAL_OTHER_CONF = "You have to choose Differential input "+
                                                           "in other configuration tab..";
        ...
        //
        // Vdda Range (volts)     Referece    Cap Ratio 
        // 2.7 <= Vdda < 3.75     Vdda/3      1/3
        // 3.75 <= Vdda < 5.2     Vdda/4      1/4
        ...
        {
            return CheckFreq(CyADC_DelSigParameters.RESOLUTION, CyADC_DelSigParameters.INPUT_BUFFER_GAIN,
        ...
        {
            return CheckFreq(CyADC_DelSigParameters.RESOLUTION_CONFIG2, 
        ...
        {
            return CheckFreq(CyADC_DelSigParameters.RESOLUTION_CONFIG3, 
        ...
        {
            return CheckFreq(CyADC_DelSigParameters.RESOLUTION_CONFIG4, 
